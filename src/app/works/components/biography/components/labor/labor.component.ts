...
info: MoreInfo[] = [
  ...
  },
  {
    id: 1,
    subtitle: 'Tareas:',
    text: 'Diseño y realización de entrevistas con usuarios, análisis de problema, estudio de la lógica del negocio, diseño UX | UI, flujo de interacción, arquitectura de la información, test con usuarios finales, diseño de prototipos y presentaciones al cliente. Participó durante un año en el proyecto, diseñó la aplicación completa y llegó a ocupar el rol de Analista Funcional y Product Owner por el conocimiento adquirido de la lógica del negocio. El proyecto se llevó a cabo aplicando metodologías ágiles y uso de tablero.',
    subtitle_1: 'Metodología:',
    text_1: 'Scrum',
    subtitle_2: 'Tecnologías:',
  ...
  },
  {
    id: 3,
    subtitle: 'Objetivo:',
    text: 'Diseñar e implementar un sistema web que sirva como plataforma de diversas apps online. Implementar una app dentro de la plataforma implementada, en base a un paradigma de prueba y recolección de datos. Prueba de la plataforma y de la app.',
    subtitle_1: 'Tareas:',
    ...
    text_5: 'Adobe Xd, Trello, HTML5, CSS3, SASS, Node.js, Angular 10, Angular Material, Firebase, Google Analytics, Swagger, Bitbucket.',
    subtitle_6: '',
    text_6: '',
