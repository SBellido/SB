...
export class VLifeComponent implements OnInit {
  ...
  images : GalleryImage[] = [
    ...
    { src: '../assets/images/ux_ui/v-life/patient/9.png', position: 9, alt: 'string', first: false, last: false },
    { src: '../assets/images/ux_ui/v-life/patient/10.png', position: 10, alt: 'string', first: false, last: false },
    { src: '../assets/images/ux_ui/v-life/patient/12.png', position: 12, alt: 'string', first: false, last: false },
    { src: '../assets/images/ux_ui/v-life/patient/13.png', position: 13, alt: 'string', first: false, last: false },
    { src: '../assets/images/ux_ui/v-life/patient/14.png', position: 14, alt: 'string', first: false, last: false },
    ...
    { src: '../assets/images/ux_ui/v-life/patient/17.png', position: 17, alt: 'string', first: false, last: false },
    { src: '../assets/images/ux_ui/v-life/patient/18.png', position: 18, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/19.png', position: 19, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/20.png', position: 20, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/21.png', position: 21, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/22.png', position: 22, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/23.png', position: 23, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/24.png', position: 24, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/25.png', position: 25, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/26.png', position: 26, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/27.png', position: 27, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/28.png', position: 28, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/29.png', position: 29, alt: 'string', first: false, last: true },
    { src: '../assets/images/ux_ui/v-life/patient/30.png', position: 30, alt: 'string', first: false, last: true },
