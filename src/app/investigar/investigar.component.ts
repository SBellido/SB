...
export class InvestigarComponent implements OnInit {
  ...
  images : GalleryImage[] = [
    { src: '../assets/images/dev/mobile/0.png', position: 0, alt: 'string', first: false, last: false },
    ...
    { src: '../assets/images/dev/mobile/8_.png', position: 9, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/9.png', position: 10, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/10.png', position: 11, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/12.png', position: 12, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/14.png', position: 13, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/13.png', position: 14, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/15.png', position: 15, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/16.png', position: 16, alt: 'string', first: false, last: false },
    { src: '../assets/images/dev/mobile/13.png', position: 17, alt: 'string', first: false, last: false },
  ]
